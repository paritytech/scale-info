...
use crate::tm_std::*;
use crate::{form::{CompactForm, Form, MetaForm}, Type, Path, meta_type::{MetaType, MetaTypeGeneric, MetaTypeConcrete}, TypeInfo};
...
impl InternedTypeDef {
	pub fn new(path: Path, ty: Type) -> Self {
		Self {
			path,
			ty,
		}
