        ...
        Type::builder()
            ...
            .variant(
                Variants::with_fields()
                    .variant_unit("None")
                    .variant("Some", Fields::unnamed().field_of::<u128, _>("T", |_| {}))
            )
    );
    assert_type!(
        Result<bool, String>,
        Type::builder()
            ...
            .variant(
                Variants::with_fields()
                    .variant("Ok", Fields::unnamed().field_of::<bool, _>("T", |_| {}))
                    .variant("Err", Fields::unnamed().field_of::<String, _>("E", |_| {}))
            )
    );
    assert_type!(
        PhantomData<i32>,
...
fn struct_with_generics() {
        ...
        T: TypeInfo + 'static,
    {
        ...
        fn type_info() -> Type {
            Type::builder()
                ...
                .composite(Fields::named().field_of::<T, _>("data", "T", |_| {}))
        }
    }
    ...
    let struct_bool_type_info = Type::builder()
        ...
        .composite(Fields::named().field_of::<bool, _>("data", "T", |_| {}));
    ...
    let expected_type = Type::builder()
        ...
        .composite(Fields::named().field_of::<Box<MyStruct<bool>>, _>("data", "T", |_| {}));
