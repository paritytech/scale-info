...
//
// For example, the following struct needs the bound `A: TypeInfo + 'static, B:
// TypeInfo + 'static`.
//
//     struct S<'b, A, B: 'b, C> {
//         a: A,
...
pub fn with_bound(
    ...
    impl<'ast> FindTyParams<'ast> {
        ...
        fn visit_path(&mut self, path: &'ast syn::Path) {
            // TODO: sort out what we need here; I think this does not apply to us, we ask users to `skip` PhantomData fields
    ...
    let new_predicates = generics
        ...
        .map(|bounded_ty| {
            syn::WherePredicate::Type(syn::PredicateType {
                lifetimes: None, // TODO: we'll want `'static` here
                // the type parameter that is being bounded e.g. T
                bounded_ty: syn::Type::Path(bounded_ty),
                colon_token: <Token![:]>::default(),
                // the bound e.g. TypeInfo
...
// TODO: I don't understand what this does/what it's useful for.
                    ...
                    syn::AngleBracketedGenericArguments {
                        ...
                        args: cont
                            ...
                            .map(|param| match param {
                                ...
                                syn::GenericParam::Const(_) => {
                                    panic!("scale-info does not support const generics yet");
                                }
                            })
                            .collect(),
