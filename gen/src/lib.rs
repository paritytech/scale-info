...
impl GenerateType for TypeDefComposite<CompactForm> {
    ...
    fn generate_type(&self, tokens: &mut TokenStream, ty: &Type<CompactForm>, registry: &RegistryReadOnly) {
...
impl GenerateType for TypeDefPrimitive {
    ...
    fn generate_type(&self, _tokens: &mut TokenStream, _ty: &Type<CompactForm>, _registry: &RegistryReadOnly) {
    }
}
