        ...
        Type::builder()
            ...
            .variant(
                Variants::with_fields()
                    .variant_unit("None")
                    .variant("Some", Fields::unnamed().field_of::<T, _>("T", |_| {})),
            )
    }
}
    ...
    E: TypeInfo + 'static,
{
    ...
    fn type_info() -> Type {
        Type::builder()
            ...
            .variant(
                Variants::with_fields()
                    .variant("Ok", Fields::unnamed().field_of::<T, _>("T", |_| {}))
                    .variant("Err", Fields::unnamed().field_of::<E, _>("E", |_| {})),
            )
    }
}
    ...
    V: TypeInfo + 'static,
{
    ...
    fn type_info() -> Type {
        Type::builder()
            ...
            .composite(Fields::unnamed().field_of::<[(K, V)], _>("[(K, V)]", |_| {}))
    }
}
